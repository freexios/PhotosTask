...
- (void)baseInit
{
    ...
    if ([language hasPrefix:@"ar"]) {
        ...
        self.transform = CGAffineTransformIdentity; //CGAffineTransformMakeRotation(M_PI);
    }
...
- (void)initImageViews
{
    ...
    for (int i = 0; i < self.maxRating; ++i) {
        ...
        emptyImageView.transform = CGAffineTransformMakeRotation(M_PI);
        ...
        fullImageView.transform = CGAffineTransformMakeRotation(M_PI);
