...
//            [btnBarDate setTitle:[monthFormatter stringFromDate:datein]];
            ...
            btnBarDate.text = [NSString stringWithFormat: @"%@", [monthFormatter stringFromDate:datein]];
...
//        [btnBarDate setTitle:[monthFormatter stringFromDate:[NSDate date]]];
        ...
        btnBarDate.text = [NSString stringWithFormat: @"%@", [monthFormatter stringFromDate:[NSDate date]]];
...
//    [btnBarDate setTitle:[monthFormatter stringFromDate:date]];
    ...
    btnBarDate.text = [NSString stringWithFormat: @"%@", [monthFormatter stringFromDate:date]];
...
-(void)showCalendarInView:(UIView *)view{
    ...
    self.frame=CGRectMake(5,mainScreenFrame.size.width/2, (mainScreenFrame.size.width-10), 470);
    self.hidden=NO;
